...
try:
    import requests
except ModuleNotFoundError:  # dependency declared in SKILL.md
    requests = None
from _modelscope_common import file_signature
from mindie_exec import process_identity
...
def launch_worker(
    ...
    *,
    ...
    from mindie_receipt import context_environment
...
def run_verify(spec: ModelSpec, revision: str) -> int:
    ...
    from mindie_receipt import operation, captured_stderr, context_environment
